syms theta(t) x(t) phi(t) T Tp N P Nm Pm Nf R L Lm l mw mp M Iw Ip Im g
...
theta_dot2 = diff(theta,t,2);
theta_sin = sin(theta);
theta_cos = cos(theta);
theta_S_dot2 = diff(theta_sin,t,2);
theta_C_dot2 = diff(theta_cos,t,2);
...
%摆杆力学方程：
equa3 = N-Nm == mp*(x_dot2 + L*theta_S_dot2);
equa4 = P-Pm - mp*g == mp*L*theta_C_dot2;
